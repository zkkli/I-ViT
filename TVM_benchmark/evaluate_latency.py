...
parser.add_argument(
    "--log-path", default="result/deit.json", help="log_file path (.json)"
)
parser.add_argument("--target", default="cuda -model=2080ti", help="tvm target")
...
def main():
    ...
    measure_ctx = auto_scheduler.LocalRPCMeasureContext(
        repeat=1, min_repeat_ms=500, timeout=1000
    )
